package com.cofe.solution.ui.user.login.view;
...
public class UserLoginActivity extends DemoBaseActivity<UserLoginPresenter> implements UserLoginContract.IUserLoginView, View.OnClickListener {
    ...
    private void initView() {
        ...
        TextView forgotTxtv = findViewById(R.id.forgot_txtv);
        forgotTxtv.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        TextView btnRegister = findViewById(R.id.btn_user_register);
        ...
        ImageView userLoginPasswdIcon = findViewById(R.id.userLoginPasswdIcon);
        userLoginPasswdIcon.setOnTouchListener(new View.OnTouchListener() {
            @Override
