package com.cofe.solution.ui.device.add.quick.presenter;
        ...
        if (DevDataCenter.getInstance().getLoginType() == LOGIN_NONE) {
            ...
            AccountManager.getInstance().addDev(xmDevInfo, isUnbindDevUnderOther, new BaseAccountManager.OnAccountManagerListener() {
                ...
                public void onFailed(int msgId, int errorId) {
                    Toast.makeText(iDevQuickConnectView.getContext(), iDevQuickConnectView.getContext().getString(R.string.add_f) , Toast.LENGTH_LONG).show();
