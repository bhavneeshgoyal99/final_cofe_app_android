 ...
 * Use the {@link DevRecordFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DevRecordFragment extends DemoBaseFragment<DevRecordPresenter> implements DevRecordContract.IDevRecordView, XTitleBar.OnRightClickListener  {
    ...
    public DevRecordFragment() {
        // Required empty public constructor
    }

    public static DevRecordFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragmentView = inflater.inflate(R.layout.fragment_dev_record, container, false);
        initView(fragmentView);
        initData(fragmentView);
        return fragmentView;
    }
    ...
    private void initView(View fragmentView) {
        ...
        noPlayBackTxtv = fragmentView.findViewById(R.id.no_play_back_txtv);

        /*fragmentView.findViewById(R.id.img_btn).setVisibility(View.VISIBLE);
        fragmentView.findViewById(R.id.img_btn).setOnClickListener(new View.OnClickListener() {
            @Override
...
//                presenter.searchMediaFileCalendar(searchMonthCalendar);
        ...
        rvRecordList = fragmentView.findViewById(R.id.rv_records);
        rvRecordFun = fragmentView.findViewById(R.id.rv_record_fun);
        tvPlaySpeed = fragmentView.findViewById(R.id.tv_play_speed);
        ((RadioButton) fragmentView.findViewById(R.id.rb_by_file)).setChecked(true);
        parentLL = fragmentView.findViewById(R.id.parent_ll);
        RelativeLayout rlBanner = fragmentView.findViewById(R.id.banner_rl);
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT,
                RelativeLayout.LayoutParams.MATCH_PARENT);
        rvRecordTimeAxis = new XMRecyclerView(activity, null);
        ...
        xmSeekBar = fragmentView.findViewById(R.id.xb_seek_to_record);
    ...
    private void initData(View fragmentView) {
        Intent intent = activity.getIntent();
        recordType = intent.getIntExtra("recordType", PLAY_DEV_PLAYBACK);
        int chnId = presenter.getChnId();
        ...
        rvRecordFun.setLayoutManager(new GridLayoutManager(activity, 4));
        rvRecordFun.setAdapter(recordFunAdapter);

        rvRecordList.setLayoutManager(new LinearLayoutManager(activity));
        recordListAdapter = new RecordListAdapter();
        rvRecordList.setAdapter(recordListAdapter);

        recordTimeAxisAdapter = new RecordTimeAxisAdapter(activity,
...
//        showWaitDialog();
        presenter.initRecordPlayer((ViewGroup) fragmentView.findViewById(R.id.layoutPlayWnd), recordType);
...
//            hideWaitDialog();
    ...
    public void onSearchCalendarResult(boolean isSuccess, Object result) {
        ...
        if (result instanceof String) {
            XMPromptDlg.onShow(activity, (String) result, null);
        } else {
            ...
            CustomCalendarDialog dialog = new CustomCalendarDialog(activity, highlightedDates, selectedDate -> {
                // Handle selected date
                Toast.makeText(activity, "Selected: " + selectedDate, Toast.LENGTH_SHORT).show();
...
//            hideWaitDialog();
            Toast.makeText(activity, getString(R.string.download_f), Toast.LENGTH_LONG).show();
        } else if (state == DOWNLOAD_STATE_START) {
            Toast.makeText(activity, getString(R.string.download_start), Toast.LENGTH_LONG).show();
//            hideWaitDialog();
        } else if (state == DOWNLOAD_STATE_COMPLETE_ALL) {
            Toast.makeText(activity, getString(R.string.download_s), Toast.LENGTH_LONG).show();
...
//            hideWaitDialog();
    ...
    public class RecordListAdapter extends RecyclerView.Adapter<RecordListAdapter.ViewHolder> {
        ...
        public RecordListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new RecordListAdapter.ViewHolder(LayoutInflater.from(parent.getContext())
        ...
        private void startVideoDeleteWork() {
            XMPromptDlg.onShow(activity, getString(R.string.is_sure_delete_cloud_video), new View.OnClickListener() {
                @Override
                public void onClick(View v) {
//                    showWaitDialog();
                    presenter.stopPlay();
