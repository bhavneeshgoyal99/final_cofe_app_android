package com.cofe.solution.ui.user.register.view;
...
import com.cofe.solution.ui.user.register.listener.UserRegisterContract;
import com.cofe.solution.ui.user.register.presenter.UserRegisterPresenter;
...
public class UserRegisterActivity extends DemoBaseActivity<UserRegisterPresenter>
    ...
    private ImageView backPressImg;
    ...
    private void initView() {
        ...
        etUserName = findViewById(R.id.et_user_register_username1);
        etEmail = findViewById(R.id.et_user_register_email1);
        etPhone = findViewById(R.id.et_user_register_phone);
        etVerifyCode = findViewById(R.id.et_user_register_verify_code1);   // verify code ed
        etPassWord = findViewById(R.id.et_user_register_psw_1);
        etPassWordConfirm = findViewById(R.id.et_user_register_psw_confirm1);
        backPressImg = findViewById(R.id.back_arrow);
        Button btnRegisterByNotBind = findViewById(R.id.btn_register_not_bind);
        btnRegisterByNotBind.setOnClickListener(this);
        backPressImg.setOnClickListener(this);

        btn_get_verify_code = findViewById(R.id.btn_get_verify_code1);  /// gete btn
        btn_get_verify_code.setOnClickListener(this);
        Button registerBtn = (Button) findViewById(R.id.userRegisterBtn1);
        ...
        ImageView passwdIcon = findViewById(R.id.userReigsterPasswdIcon);
        ImageView rePasswdIcon = findViewById(R.id.userReigsterRePasswdIcon);
        passwdIcon.setOnTouchListener(new View.OnTouchListener() {
            @Override
        ...
        rePasswdIcon.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    // Show the password
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            break;
            case R.id.btn_get_verify_code1: {
                tryGetVerifyCode();
            }
            break;
            case R.id.userRegisterBtn1: {
                tryToRegister();
            }
            break;
