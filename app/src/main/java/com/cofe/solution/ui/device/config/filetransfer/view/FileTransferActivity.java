package com.cofe.solution.ui.device.config.filetransfer.view;
...
import com.cofe.solution.ui.device.config.filetransfer.contract.FileTransferContract;
import com.cofe.solution.ui.device.config.filetransfer.presenter.FileTransferPresenter;
...
public class FileTransferActivity extends BaseConfigActivity<FileTransferPresenter> implements FileTransferContract.IDvrCustomAlarmVoiceView {
    ...
    public void onInitResult(boolean isSuccess, int errorId) {
        if (!isSuccess) {
            showToast(getString(R.string.upload_f) , Toast.LENGTH_LONG);
        }
    }
    ...
    public void onGetAudioListResult(boolean isSuccess, List<VoiceReplyBean> list, int errorId) {
        if (isSuccess) {
            ...
            showToast(getString(R.string.get_voice_list_failed) , Toast.LENGTH_LONG);
        }
    }
