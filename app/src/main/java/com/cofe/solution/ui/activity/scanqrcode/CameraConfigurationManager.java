 ...
 *
 * Description: This class is responsible for setting camera parameters and obtaining the best preview interface
 */
public final class CameraConfigurationManager {
	...
	public void initFromCameraParameters(Camera camera) {
		...
		/**Because of the switch to portrait display, the preview image obtained without replacing the screen width and height is distorted**/
	...
	public void setDesiredCameraParameters(Camera camera, boolean safeMode) {
		...
		/** 设置相机预览为竖屏 */
		/** Set camera preview to portrait */
	 ...
	 * Calculate the most appropriate preview interface size from the resolution supported by the camera
	 *
	 * @param parameters
