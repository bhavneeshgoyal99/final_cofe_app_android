...
import com.cofe.solution.ui.device.aov.listener.AovSettingContract;
import com.cofe.solution.ui.device.aov.presenter.AovSettingPresenter;
...
public class AovSettingActivity extends BaseConfigActivity<AovSettingPresenter> implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            workingId = getIntent().getStringExtra("working");
        } catch(Exception e){
            e.printStackTrace();
        }
    ...
    public void showSupportAovAbility(boolean isSupportLight, boolean isSupportWorkMode,
        ...
        if(workingId!=null) {
            lsiWorkModeSettings.performClick();
        }
