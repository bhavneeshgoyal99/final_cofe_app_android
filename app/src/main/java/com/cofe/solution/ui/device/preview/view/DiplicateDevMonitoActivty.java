...
import com.cofe.solution.ui.device.preview.listener.MyHomeClickReceiver;
...
public class DiplicateDevMonitoActivty extends DemoBaseActivity<DevMonitorPresenter> implements DevMonitorContract.IDevMonitorView,
        OnClickListener, SensorChangeContract.ISensorChangeView, RealTimeFragment.OnFeatureClickListener, DetectTrackFragment.OnFragmentCallbackListener {
    private static final String TAG = "DiplicateDevMonitoActivty";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dp_activity_device_camera);
    ...
    void checkAOVBattery(boolean isPreviewChange) {
        DeviceManager.getInstance().getDevAllAbility(presenter.getDevId(), new DeviceManager.OnDevManagerListener<SystemFunctionBean>() {
            ...
            public void onSuccess(String devId, int operationType, SystemFunctionBean result) {
                Log.d("login Device id " , " presenter.getDevId() > "  +presenter.getDevId());
                Log.d("login  Device id " , " result.OtherFunction.AovMode > "  +result.OtherFunction.AovMode);
                Log.d("login Device id " , " result.OtherFunction.BatteryManager > "  +result.OtherFunction.BatteryManager);
            ...
            public void onFailed(String devId, int msgId, String jsonName, int errorId) {
                Log.d("login onFailed > ", " errorId > "  +errorId);
                Log.d("login onFailed > ", " jsonName > "  +jsonName);
            }
        });
    }
    ...
    private void initView() {
        ...
        rotateScreen.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (getResources().getConfiguration().orientation != Configuration.ORIENTATION_LANDSCAPE) {
                    ...
                    screenOrientationManager.portraitScreen(DiplicateDevMonitoActivty.this, true);
                }
            }
        });
        ...
        openSetting.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i =new Intent (DiplicateDevMonitoActivty.this, DeviceSetting.class);
            ...
            public void onConfigureTab(@NonNull TabLayout.Tab tab, int position) {
                switch (position) {
                    case 0:
                        ...
                        break;
                    case 1:
                        tab.setText(getString(R.string.playback_text));
                        break;
                    case 2:
        ...
        //mHomeClickReceiver = new DiplicateDevMonitoActivty.MyHomeClickReceiver();
...
//                }
        ...
        sbVideoScale.setOnScaleSeekBarListener(new XMScaleSeekBar.OnScaleSeekBarListener() {
            ...
            public void onItemSelected(int progress, boolean isTouchUp) {
                if (isTouchUp) {
                    MonitorManager monitorManager = presenter.getCurSelMonitorManager(playWndLayout.getSelectedId());
                    if (monitorManager != null) {
                        SPUtil.getInstance(DiplicateDevMonitoActivty.this).setSettingParam(LAST_CHANGE_SCALE_TIMES + presenter.getDevId(), (float) (progress * ((float) 1 / sbVideoScale.getSmallSubCount())));
    ...
    private void initData() {
        ...
        Log.d(TAG, "initData chnCount >  " + chnCount  );
    ...
    public void onGetDevAbilityResult(SystemFunctionBean systemFunctionBean, int errorId) {
        ...
        if (systemFunctionBean != null) {
            ...
            SPUtil.getInstance(DiplicateDevMonitoActivty.this).setSettingParam(SUPPORT_SCALE_TWO_LENS + presenter.getDevId(), systemFunctionBean.OtherFunction.SupportScaleTwoLens);
            SPUtil.getInstance(DiplicateDevMonitoActivty.this).setSettingParam(SUPPORT_SCALE_THREE_LENS + presenter.getDevId(), systemFunctionBean.OtherFunction.SupportScaleThreeLens);

            //将双目或者三目设备 是否需要APP支持变倍的能力保存到本地
            SPUtil.getInstance(DiplicateDevMonitoActivty.this).setSettingParam(MULTI_LENS_TWO_SENSOR + presenter.getDevId(), systemFunctionBean.OtherFunction.MultiLensTwoSensor);
            SPUtil.getInstance(DiplicateDevMonitoActivty.this).setSettingParam(MULTI_LENS_THREE_SENSOR + presenter.getDevId(), systemFunctionBean.OtherFunction.MultiLensThreeSensor);
    ...
    private boolean dealWithMonitorFunction(int itemId, boolean isSelected) {
        switch (itemId) {
                ...
                XMPromptDlg.onShowEditDialog(this, getString(R.string.food_portions), "3", new EditDialog.OnEditContentListener() {
                    ...
                    public void onResult(String content) {
                        if (StringUtils.isStringNULL(content)) {
                            ...
                            XMPromptDlg.onShow(DiplicateDevMonitoActivty.this, getString(R.string.please_sel_feet_type), getString(R.string.feed_the_dog), getString(R.string.feed_the_fish), new OnClickListener() {
                                @Override
                                public void onClick(View v) {
            ...
            case FUN_RESET://恢复出厂设置
                XMPromptDlg.onShow(DiplicateDevMonitoActivty.this, getString(R.string.factory_reset), getString(R.string.only_factory_reset), getString(R.string.factory_reset_and_delete_dev), new OnClickListener() {
                    @Override
                    public void onClick(View v) {
            ...
            case FUN_POINT://指哪看那
                ...
                if (!isShowAppMoreScreen) {
                    ...
                    if (isOpenPointPtz) {
                        XMPromptDlg.onShow(DiplicateDevMonitoActivty.this, getString(R.string.camera_point_ptz_tips), null);
                    }
            ...
            case FUN_ALARM_BY_VOICE_LIGHT: //声光报警
                switch (getSupportLightType(systemFunctionBean)) {
                    ...
                    case LOW_POWER_WHITE_LIGHT_CAMERA:
                        Intent intent = new Intent(DiplicateDevMonitoActivty.this, WhiteLightActivity.class);
                    ...
                    case WHITE_LIGHT_CAMERA:
                        Intent whiteLightIntent = new Intent(DiplicateDevMonitoActivty.this, WhiteLightActivity.class);
                    ...
                    case DOUBLE_LIGHT_CAMERA:
                        Intent doubleLightIntent = new Intent(DiplicateDevMonitoActivty.this, DoubleLightActivity.class);
                    ...
                    case MUSIC_LIGHT_CAMERA:
                        Intent musicLightIntent = new Intent(DiplicateDevMonitoActivty.this, MusicLightActivity.class);
                    ...
                    case GARDEN_DOUBLE_LIGHT_CAMERA:
                        Intent GardenDoubleLightIntent = new Intent(DiplicateDevMonitoActivty.this, GardenDoubleLightActivity.class);
            ...
            case FUN_SHOW_APP_ZOOMING://APP软变倍
                ...
                if (isShowAPPZooming) {
                    ...
                    int maxTimes = 3;
                    int maxTimesShow = 6;
                    float scale = SPUtil.getInstance(DiplicateDevMonitoActivty.this).getSettingParam(LAST_CHANGE_SCALE_TIMES + presenter.getDevId(), 0f);
                    sbVideoScale.setProgress((int) (scale * sbVideoScale.getSmallSubCount()));
            ...
            case FUN_APP_OBJ_EFFECT://APP软件实现多目效果
                ...
                return true;
            default:
                Toast.makeText(DiplicateDevMonitoActivty.this, getString(R.string.not_support_tip), Toast.LENGTH_LONG).show();
                break;
        }
    ...
    private void changePlayViewSize() {
        ...
        /*if (isOpenPointPtz || isShowAppMoreScreen) {
            layoutParams.height = XUtils.getScreenWidth(DiplicateDevMonitoActivty.this) * 18 / 16;
        } else {
            layoutParams.height = XUtils.getScreenWidth(DiplicateDevMonitoActivty.this) * 9 / 16;
        }*/
    ...
    private void dealWithTourCtrl(int presetId) {
        ...
        XMPromptDlg.onShow(DiplicateDevMonitoActivty.this, "是否设置巡航点?", new OnClickListener() {
            @Override
            public void onClick(View v) {
            ...
            for (TourBean tourBean : tourBeans) {
                if (tourBean != null) {
                    if (tourBean.Id == presetId) {//判断巡航点是否设置了
                        XMPromptDlg.onShow(DiplicateDevMonitoActivty.this, "确定删除该巡航点?", new OnClickListener() {
                            @Override
                            public void onClick(View v) {
     ...
     * 监听home键的按下
     */
     /*mHomeClickReceiver = new BroadcastReceiver() {
