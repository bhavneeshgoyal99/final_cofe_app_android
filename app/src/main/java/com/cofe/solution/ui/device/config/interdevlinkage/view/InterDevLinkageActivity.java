package com.cofe.solution.ui.device.config.interdevlinkage.view;
...
import com.cofe.solution.ui.device.config.interdevlinkage.listener.InterDevLinkageContract;
import com.cofe.solution.ui.device.config.interdevlinkage.presenter.InterDevLinkagePresenter;
...
public class InterDevLinkageActivity extends DemoBaseActivity<InterDevLinkagePresenter>
    ...
    public void onInterDevLinkResult(boolean isSuccess, int errorId) {
        ...
        if (isSuccess) {
            ...
            showToast(getString(R.string.inter_dev_linked_f) , Toast.LENGTH_LONG);
        }
    }
    ...
    public void onInterDevUnlinkResult(boolean isSuccess, int errorId) {
        ...
        if (isSuccess) {
            ...
            showToast(getString(R.string.inter_dev_unlinked_f) , Toast.LENGTH_LONG);
        }
    }
