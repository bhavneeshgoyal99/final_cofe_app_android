package com.cofe.solution.ui.device.config.intelligentvigilance.view;
...
import com.cofe.solution.ui.device.config.intelligentvigilance.listener.IntelligentVigilanceContract;
import com.cofe.solution.ui.device.config.intelligentvigilance.presenter.IntelligentVigilancePresenter;
...
public class IntelligentVigilanceActivity extends BaseConfigActivity<IntelligentVigilancePresenter> implements IntelligentVigilanceContract.IIntelligentVigilanceView {
    ...
    public void updateHumanDetectResult(boolean isSuccess, int errorId) {
        ...
        if (isSuccess) {
            ...
            showToast(getString(R.string.dev_get_human_dissupport) , Toast.LENGTH_LONG);
            finish();
        }
    }
