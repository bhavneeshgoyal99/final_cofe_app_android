package com.cofe.solution.ui.device.config.simpleconfig.view;
...
import com.cofe.solution.ui.device.config.simpleconfig.listener.DevSimpleConfigContract;
import com.cofe.solution.ui.device.config.simpleconfig.presenter.DevSimpleConfigPresenter;
        ...
        btnShareDevData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Uri fileUri = FileProvider.getUriForFile(DevSimpleConfigActivity.this, "com.cofe.solution.fileprovider", file);
